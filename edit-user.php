                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="" name="name" value="<?= $result['name'] ?>"
                                placeholder="Enter a new name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Email</label>
                            <input type="email" id="" name="email" value="<?= $result['email'] ?>"
                                placeholder="Enter a new email" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="" name="password" placeholder="Enter a new password"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn-sm btn-primary mt-2" name="edit_user">Update</button>
                        </div>
                    </form>
