    ...
    <div class="py-3">
        ...
        <div class="row">
            ...
            <table id="myorders" class="table table-striped">
                ...
                <tbody>
                    <?php 
                    $sql = "SELECT o.* FROM orders o JOIN (SELECT order_id, MAX(id) AS maxid FROM orders GROUP BY order_id) x ON o.order_id = x.order_id AND o.id = x.maxid ORDER BY o.id DESC";
